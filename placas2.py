...
#Realizamos la lectura de la videoCaptura
    ...
    cv2.drawContours(umbral, contornos, -1, (0,255,0), 3)
    cv2.imshow("umbral", umbral)
    ...
    for contorno in contornos:
        ...
        #Binarizamos l aimagen
        umbral2 = Color2
        #ret, umbral2 = cv2.threshold(Color2, 40, 255, cv2.THRESH_BINARY)
